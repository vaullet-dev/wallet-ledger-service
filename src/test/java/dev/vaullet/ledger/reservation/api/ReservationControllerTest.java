...
import dev.vaullet.common.security.PlatformSecurityAutoConfiguration;
...
class ReservationControllerTest {
    ...
    void mapsInsufficientFundsToConflict() {
        ...
        result.bodyJson().extractingPath("$.type").isEqualTo("https://docs.vaullet.dev/errors/insufficient-funds");
    }
